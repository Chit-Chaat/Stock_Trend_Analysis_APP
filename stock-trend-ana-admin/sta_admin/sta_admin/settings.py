"""
Django settings for sta_admin project.
...
SECRET_KEY = 'kz%cgz9&n@rv4uw4e+c=ssezu+0t=$n)^08xi*mo0d6$0xzm-b'
...
WSGI_APPLICATION = 'sta_admin.wsgi.application'
